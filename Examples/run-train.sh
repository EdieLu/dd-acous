...
set LOG=$1
set TRAIN=/home/alta/BLTSpeaking/exp-ytl28/encdec/acous-dd-run-v2/train.sh
# set TRAIN=/home/alta/BLTSpeaking/exp-ytl28/encdec/acous-dd-run-v2/train-combine.sh
