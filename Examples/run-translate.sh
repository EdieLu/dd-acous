...
set LOG=$1
# set TRANSLATE=/home/alta/BLTSpeaking/exp-ytl28/encdec/acous-las-run-v1/translate.sh
set TRANSLATE=/home/alta/BLTSpeaking/exp-ytl28/encdec/acous-las-run-v1/translate-combine.sh 
# set TRANSLATE=/home/alta/BLTSpeaking/exp-ytl28/encdec/acous-las-run-v1/translate-asr-batch.sh
